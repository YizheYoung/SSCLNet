...
class F1_score:
    ...
    def evaluate_mask(self):
        precision_0 = self.hist_mask[0][0]/(self.hist_mask[1][0] + self.hist_mask[0][0] + self.hist_mask[2][0] + self.hist_mask[3][0] + self.hist_mask[4][0])
        recall_0 = self.hist_mask[0][0]/(self.hist_mask[0][1]+ self.hist_mask[0][0] + self.hist_mask[0][2] + self.hist_mask[0][3] + self.hist_mask[0][4])
        f_0 = 2*precision_0*recall_0/(precision_0 + recall_0)

        precision_1 = self.hist_mask[1][1]/(self.hist_mask[1][1] + self.hist_mask[0][1] + self.hist_mask[2][1] + self.hist_mask[3][1] + self.hist_mask[4][1])
        recall_1 = self.hist_mask[1][1]/(self.hist_mask[1][1]+ self.hist_mask[1][0] + self.hist_mask[1][2] + self.hist_mask[1][3] + self.hist_mask[1][4])
        f_1 = 2*precision_1*recall_1/(precision_1 + recall_1)

        precision_2 = self.hist_mask[2][2]/(self.hist_mask[2][2] + self.hist_mask[0][2] + self.hist_mask[1][2] + self.hist_mask[3][2] + self.hist_mask[4][2])
        recall_2 = self.hist_mask[2][2]/(self.hist_mask[2][2]+ self.hist_mask[2][1] + self.hist_mask[2][0] + self.hist_mask[2][3] + self.hist_mask[2][4])
        f_2 = 2*precision_2*recall_2/(precision_2 + recall_2)

        precision_3 = self.hist_mask[3][3]/(self.hist_mask[3][3] + self.hist_mask[0][3] + self.hist_mask[1][3] + self.hist_mask[2][3] + self.hist_mask[4][3])
        recall_3 = self.hist_mask[3][3]/(self.hist_mask[3][3]+ self.hist_mask[3][1] + self.hist_mask[3][2] + self.hist_mask[3][0] + self.hist_mask[3][4])
        f_3 = 2*precision_3*recall_3/(precision_3 + recall_3)
        
        precision_4 = self.hist_mask[4][4]/(self.hist_mask[4][4] + self.hist_mask[0][4] + self.hist_mask[1][4] + self.hist_mask[2][4] + self.hist_mask[3][4])
        recall_4 = self.hist_mask[4][4]/(self.hist_mask[4][4]+ self.hist_mask[4][1] + self.hist_mask[4][2] + self.hist_mask[4][3] + self.hist_mask[4][0])
